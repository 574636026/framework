...
$.extend(true, DataTable.defaults, {
  dom: "<'am-g am-datatable-hd'<'am-u-sm-12'f>>" +
  "<'am-g'<'am-u-sm-12'tr>>" +
  "<'am-g am-padding-vertical am-datatable-footer'<'am-u-sm-3'l><'am-u-sm-3'i><'am-u-sm-6 am-u-end'p>>",
  renderer: 'amazeui'
});
...
$.extend(DataTable.ext.classes, {
  ...
  sLength: 'dataTables_length am-form-inline am-datatable-length',
  sLengthSelect: 'am-input-sm',
