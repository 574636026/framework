...
public abstract class AndroidNotification extends UmengNotification {
	...
	public boolean setExtraField(String key, String value) throws PushException {
		JSONObject payloadJson = null;
	...
	//
	public void setDisplayType(DisplayType d) throws PushException {
		setPredefinedKeyValue("display_type", d.getValue());
	}

	/** 通知栏提示文字 */
	public void setTicker(String ticker) throws PushException {
		setPredefinedKeyValue("ticker", ticker);
	}

	/** 通知标题 */
	public void setTitle(String title) throws PushException {
		setPredefinedKeyValue("title", title);
	}

	/** 通知文字描述 */
	public void setText(String text) throws PushException {
		setPredefinedKeyValue("text", text);
	}

	/** 用于标识该通知采用的样式。使用该参数时, 必须在SDK里面实现自定义通知栏样式。 */
	public void setBuilderId(Integer builder_id) throws PushException {
		setPredefinedKeyValue("builder_id", builder_id);
	}

	/** 状态栏图标ID, R.drawable.[smallIcon],如果没有, 默认使用应用图标。 */
	public void setIcon(String icon) throws PushException {
		setPredefinedKeyValue("icon", icon);
	}

	/** 通知栏拉开后左侧图标ID */
	public void setLargeIcon(String largeIcon) throws PushException {
		setPredefinedKeyValue("largeIcon", largeIcon);
	}

	/** 通知栏大图标的URL链接。该字段的优先级大于largeIcon。该字段要求以http或者https开头。 */
	public void setImg(String img) throws PushException {
		setPredefinedKeyValue("img", img);
	}

	/** 收到通知是否震动,默认为"true" */
	public void setPlayVibrate(Boolean play_vibrate) throws PushException {
		setPredefinedKeyValue("play_vibrate", play_vibrate.toString());
	}

	/** 收到通知是否闪灯,默认为"true" */
	public void setPlayLights(Boolean play_lights) throws PushException {
		setPredefinedKeyValue("play_lights", play_lights.toString());
	}

	/** 收到通知是否发出声音,默认为"true" */
	public void setPlaySound(Boolean play_sound) throws PushException {
	...
	/** 收到通知后播放指定的声音文件 */
	public void setPlaySound(String sound) throws PushException {
		setPlaySound(true);
		setSound(sound);
	}

	/** 点击"通知"的后续行为，默认为打开app。 */
	public void goAppAfterOpen() throws PushException {
		setAfterOpenAction(AfterOpenAction.go_app);
	}

	public void goUrlAfterOpen(String url) throws PushException {
		setAfterOpenAction(AfterOpenAction.go_url);
		setUrl(url);
	}

	public void goActivityAfterOpen(String activity) throws PushException {
		setAfterOpenAction(AfterOpenAction.go_activity);
		setActivity(activity);
	}

	public void goCustomAfterOpen(String custom) throws PushException {
		setAfterOpenAction(AfterOpenAction.go_custom);
		setCustomField(custom);
	}

	public void goCustomAfterOpen(JSONObject custom) throws PushException {
		setAfterOpenAction(AfterOpenAction.go_custom);
		setCustomField(custom);
	}

	/// 点击"通知"的后续行为，默认为打开app。原始接口
	public void setAfterOpenAction(AfterOpenAction action) throws PushException {
		setPredefinedKeyValue("after_open", action.toString());
	}

	public void setUrl(String url) throws PushException {
		setPredefinedKeyValue("url", url);
	}

	public void setActivity(String activity) throws PushException {
		setPredefinedKeyValue("activity", activity);
	}

	/// can be a string of json
	public void setCustomField(String custom) throws PushException {
		setPredefinedKeyValue("custom", custom);
	}

	public void setCustomField(JSONObject custom) throws PushException {
		setPredefinedKeyValue("custom", custom);
	}
